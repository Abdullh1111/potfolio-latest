      ...
      <div>
        <div className="grid md:grid-cols-2 my-8 sm:my-20 gap-14">
          ...
          <div className="flex justify-center flex-col tracking-[1px] text-xl gap-5">
            <p>
            Hi, I'm Abdullah Al-Amin, a passionate web developer with a keen interest in building innovative and efficient web applications. With a solid understanding of modern technologies, I aim to create user-friendly and impactful digital solutions.
            </p>
            <p>
